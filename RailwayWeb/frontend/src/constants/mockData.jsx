...
export const ASSESSMENT_MONTHLY = [
...
export const DASHBOARD_96_STATIONS = generate96Stations();

export const stationProgressData = [
...
export const designationOptions = ["Pointsman", "Station Master", "Train Manager", "Station Supervisor", "Traffic Inspector"];
export const departmentOptions = ["Operations", "Administration", "Finance", "HR", "IT"];
export const userTypeOptions = ["AOM", "Manager", "Employee", "Viewer"];
export const reportingOfficerOptions = ["R. Kumar", "S. Deshmukh", "P. Nair", "M. Verma", "A. Singh"];

export const aomReadOnlyProfile = {
...
export const stationZoneOptions = ["Central Railway", "Western Railway", "Northern Railway", "Southern Railway", "Eastern Railway"];
export const stationDivisionOptions = ["Nagpur", "Pune", "Mumbai", "Delhi", "Chennai"];
export const stationCategoryOptions = ["A", "B", "C", "D", "Halt"];
export const stationTypeOptions = ["Junction", "Terminal", "Halt"];

export const initialStationFormData = {
  stationName: "",
  stationCode: "",
  zone: "",
  division: "",
...
export const initialStationFilterData = {
  zone: "",
  division: "",
  category: "",
  status: ""
...
export const tiCategoryOptions = ["A", "B", "C", "D"];
export const tiAssessmentStatusOptions = ["Completed", "Pending"];

export const initialTrafficInspectors = [
  {
    id: 1,
    name: "R. Khan",
    employeeId: "TI_1001",
...
export const initialTiFormData = {
  name: "",
  employeeId: "",
  jurisdiction: "",
  category: "",
...
export const stationAverageScoreData = [
...
export const initialPendingAssessments = [
  {
    id: "SM_1001",
...
export const initialApprovedAssessments = [
  {
    id: "SM_1002",
...
export const initialReportRows = [
  {
    id: "PM_1001",
    hrmsId: "PM_1001",
    name: "K. Pawar",
