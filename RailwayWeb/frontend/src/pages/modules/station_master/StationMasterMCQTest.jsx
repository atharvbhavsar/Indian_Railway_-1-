  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <div style={{display: "flex", alignItems: "center", gap: 12}}>
          ...
          <div>
            <h1 style={{fontSize: 18, fontWeight: 800, margin: 0, color: "#ffffff", letterSpacing: "0.5px"}}>
              {t("STATION MASTER CBT COMPETENCY EVALUATION")}
            </h1>
            <p style={{margin: 0, fontSize: 11, color: "#94a3b8", fontWeight: 500}}>
              {t("Official Online Railway Rules & Operational Safety Examination (2026 Cycle)")}
            </p>
          </div>
        </div>
        ...
        <div style={{display: "flex", alignItems: "center", gap: 16}}>
          <div style={{
            ...
            ⏳ {t("TIME ELAPSED:")} <span style={{color: "#3b82f6"}}>{t("Active Session")}</span>
          </div>
          
          <button 
            onClick={() => {
              if (window.confirm(t("Are you sure you want to exit the exam? Your progress will not be saved."))) {
                setPageMode("default");
              }
            }} 
            style={{
      ...
      <div style={{
        ...
        <div>
          {t("Candidate Name:")} <strong style={{color: "#1e3a8a"}}>{smName}</strong> &nbsp;|&nbsp; {t("HRMS ID:")} <strong style={{color: "#1e3a8a"}}>{smId}</strong> &nbsp;|&nbsp; {t("Station:")} <strong>{t("Nagpur Junction (NGP)")}</strong>
        </div>
        <div style={{display: "flex", alignItems: "center", gap: 12}}>
          <span style={{fontWeight: 600}}>{t("Progress:")} <strong style={{color: "#2563eb"}}>{answeredCount} / 25 {t("Answered")}</strong> ({completionRate}%)</span>
      ...
      <div style={{
          ...
          <div style={{
            ...
            <div>
              <span style={{
                ...
                {t("Question")} {activeQIdx + 1} {t("of")} 25
              </span>
            ...
            <div style={{fontSize: 14, color: "#64748b"}}>
              {unansweredCount > 0 ? (
                <span style={{color: "#d97706", fontWeight: 800, display: "flex", alignItems: "center", gap: 6}}>
                  ⚠️ {unansweredCount === 1 ? t("1 question remaining to unlock submission") : t("{count} questions remaining to unlock submission").replace("{count}", unansweredCount)}
                </span>
              ) : (
                <span style={{color: "#16a34a", fontWeight: 800, display: "flex", alignItems: "center", gap: 6}}>
                  {t("✓ All 25 questions attempted! You can now submit.")}
                </span>
              )}
            </div>
        ...
        <div style={{
          ...
          <div style={{textAlign: "center", paddingBottom: 16, borderBottom: "1.5px solid #f1f5f9"}}>
            ...
            <span style={{fontSize: 12, color: "#64748b", fontWeight: 500}}>{t("HRMS ID:")} {smId}</span>
          </div>
            ...
            >
             ...
             {unansweredCount > 0 && (
              <p style={{
                ...
                {t("* All 25 questions must be answered first ({count} remaining)").replace("{count}", unansweredCount)}
              </p>
            )}
          </div>
