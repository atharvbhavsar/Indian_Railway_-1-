...
export const initialHistory = [
  {
    id: 1,
    date: "2026-03-10",
    name: "Pointsman Periodic Assessment",
  ...
  },
  {
    ...
    totalScore: 68,
    sections: [
      { title: "Signal Rules", marks: 12, outOf: 20 },
      { title: "Track Handling", marks: 14, outOf: 20 },
      { title: "Communication", marks: 13, outOf: 20 },
      { title: "Safety Response", marks: 14, outOf: 20 },
      { title: "Operational Judgement", marks: 15, outOf: 20 }
    ],
